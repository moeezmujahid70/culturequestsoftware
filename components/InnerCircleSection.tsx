export default function InnerCircleSection() {
  return (
    <section id="inner-circle" className="bg-cream px-4 py-12 sm:px-6 sm:py-20 lg:py-28">
      <div className="mx-auto max-w-4xl" data-animate>
        <div className="rounded-[1.5rem] border border-gold/20 bg-white px-4 py-6 text-left shadow-[0_18px_40px_rgba(107,20,20,0.08)] sm:rounded-[2rem] sm:px-10 sm:py-12">
          ...
          <div className="mt-7 flex flex-col items-start gap-3 sm:mt-8 sm:flex-row sm:flex-wrap sm:items-center sm:gap-x-6 sm:gap-y-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="link-underline min-h-11 cursor-pointer font-body text-sm font-medium text-crimson transition-colors duration-200 hover:text-gold"
            >
              Explore the example
            </a>
            <a
