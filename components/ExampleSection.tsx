    ...
    >
      <div className="mx-auto max-w-7xl" data-animate>
        <div className="overflow-hidden rounded-[1.5rem] border border-gold/20 bg-cream shadow-[0_18px_40px_rgba(107,20,20,0.06)] sm:rounded-[2rem]">
          <div className="mx-auto max-w-6xl bg-white px-4 py-6 sm:px-10 sm:py-12 lg:px-16 lg:py-16">
            <div className="mx-auto max-w-4xl">
              ...
              <div className="mt-8 space-y-7 sm:mt-12 sm:space-y-10">
                <p className="text-left font-body text-[15px] leading-relaxed text-charcoal sm:text-[1.05rem]">
              ...
              <p className="mt-8 text-left font-body text-[15px] leading-relaxed text-crimson sm:mt-12 sm:text-[1.05rem]">
