  ...
  return (
    <section id="pricing" className="bg-parchment px-4 py-14 sm:px-6 sm:py-20 lg:py-32">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3 sm:gap-6 lg:gap-10">
          {[
            ...
            <div key={signal} className="flex w-full items-center justify-center gap-2 sm:w-auto">
              ...
              <span className="font-body text-[15px] font-medium text-charcoal sm:text-sm">
                {signal}
              </span>
            </div>
          ))}
        ...
        {/* Pricing cards */}
        <div
          className="no-scrollbar -mx-4 mt-10 flex snap-x snap-mandatory gap-4 overflow-x-auto px-4 pb-3 sm:mx-0 sm:mt-14 sm:grid sm:grid-cols-2 sm:overflow-visible sm:px-0 sm:pb-0 lg:grid-cols-5"
